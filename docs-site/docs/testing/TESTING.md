...
> - Backend: Go tests in `*_test.go` files alongside source, benchmarks in `internal/redirect/`
> - Frontend: Vitest + RTL in `web/src/**/__tests__/`, MSW mocks in `web/src/test/mocks/`
> - E2E: Playwright in `web/e2e/`
